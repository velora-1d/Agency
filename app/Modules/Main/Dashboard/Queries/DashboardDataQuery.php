    ...
    protected function buildMetrics(
        ...
        return [
            $this->metricCard(
                ...
                icon: 'banknotes',
                helper: 'Invoice paid pada bulan berjalan',
            ...
            $this->metricCard(
                ...
                icon: 'building',
                helper: 'Client dengan status active',
            ...
            $this->metricCard(
                ...
                icon: 'clock',
                helper: 'Status todo dan in progress',
            ...
            $this->metricCard(
                ...
                icon: 'receipt',
                helper: 'Draft, sent, partial, overdue',
            ...
            $this->metricCard(
                ...
                icon: 'spark',
                helper: 'Run otomatis pada bulan berjalan',
            ...
            $this->metricCard(
                ...
                icon: 'pulse',
                helper: 'Rasio tugas selesai terhadap total tugas bulan ini',
            ...
            $this->metricCard(
                ...
                icon: 'funnel',
                helper: 'Lead baru pada bulan berjalan',
    ...
    protected function buildQuickActions(): array
    {
        return [
            [
                'key' => 'add-client',
                'label' => 'Tambah Klien',
                'description' => 'Siapkan onboarding client baru dari dashboard.',
                'icon' => 'user-plus',
                'mode' => 'local',
            ],
            [
                'key' => 'create-project',
                'label' => 'Buat Proyek',
                'description' => 'Mulai project baru tanpa keluar dari workspace utama.',
                'icon' => 'folder-plus',
                'mode' => 'local',
            ],
            [
                'key' => 'create-invoice',
                'label' => 'Buat Invoice',
                'description' => 'Trigger draft invoice dari area finance.',
                'icon' => 'file-plus',
                'mode' => 'local',
            ],
            [
                ...
                'description' => 'Masuk ke runner workflow untuk job manual.',
                'icon' => 'zap',
                'mode' => 'local',
            ],
            [
                'key' => 'broadcast-wa',
                'label' => 'Broadcast WA',
                'description' => 'Siapkan blast WhatsApp dari workspace communication.',
                'icon' => 'megaphone',
                'mode' => 'local',
            ],
        ];
    ...
    protected function buildCategorySummary(
        ...
        return [
            [
                'key' => 'crm',
                'title' => 'CRM',
                'lineOne' => 'Total leads ' . number_format($leadsCount, 0, ',', '.'),
                'lineTwo' => 'Hot leads ' . number_format($hotLeads, 0, ',', '.'),
            ],
            [
                'key' => 'project',
                'title' => 'Proyek',
                'lineOne' => 'Ongoing ' . number_format($ongoingProjects, 0, ',', '.'),
                'lineTwo' => 'Overdue ' . number_format($overdueTasks, 0, ',', '.'),
            ],
            [
                'key' => 'finance',
                'title' => 'Keuangan',
                'lineOne' => 'Income ' . DashboardFormat::currency($income, $currency),
                'lineTwo' => 'Unpaid ' . DashboardFormat::currency($unpaid, $currency),
            ],
            [
                'key' => 'marketing',
                'title' => 'Marketing',
                'lineOne' => 'Campaign aktif ' . number_format($campaignCount, 0, ',', '.'),
                'lineTwo' => 'Top spend ' . $topSpendName,
            ],
        ];
    }

  ...
  <div class="min-h-screen bg-stone-50 px-4 py-12 sm:px-6 lg:px-8">
    <div class="mx-auto max-w-3xl">
      ...
      <div class="text-center">
        ...
        <p class="text-xs font-bold uppercase tracking-widest text-stone-400">Digital Signature Request</p>
      ...
      <div class="mt-12 overflow-hidden rounded-[2rem] border border-stone-200 bg-white shadow-xl">
        ...
        <div class="border-t border-stone-100 bg-stone-50/50 p-8 sm:p-12">
          <h3 class="text-lg font-bold text-stone-900">Sign Digitally</h3>
          ...
          <form @submit.prevent="submitSignature" class="mt-8 space-y-6">
            ...
            <div class="flex items-center justify-between gap-4 pt-4">
              <div class="text-xs text-stone-400">
                <p>IP Address: Automated Tracking</p>
                <p>Security Token: {{ token.substring(0, 8) }}...</p>
              </div>
              <button 
                type="submit" 
              ...
              >
                {{ form.processing ? 'Signing...' : 'Sign Contract Now' }}
              </button>
            </div>
          </form>
        </div>
      ...
      <div class="mt-12 text-center text-xs text-stone-400">
        <p>&copy; 2026 {{ contract.workspace_name }}. Secure Digital Signature System.</p>
      </div>
    </div>
  </div>
</template>
